...
echo ""
JSON_DATA='{"tuples":[{"resource":{"id":"bob_group","type":{"name":"group","namespace":"rbac"}},"relation":"t_direct_member","subject":{"subject":{"id":"bob","type":{"name":"principal","namespace":"rbac"}}}}]}'
